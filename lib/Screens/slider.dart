                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text(' Practice until you',style: TextStyle(color: Colors.black, fontSize: 22.0),),
                      ],
                    ),
                    Row(
                      children: [
                        Text('could get an A if there',style: TextStyle(color: Colors.black, fontSize: 22.0),),
                      ],
                    ),
                    Row(
                      children: [
                        Text('were a test tomorrow.',style: TextStyle(color: Colors.black, fontSize: 22.0),),
                      ],
                    ),
                  ],
                ),
